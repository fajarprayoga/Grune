                    ...
                    <ul class="sidebar-menu" data-widget="tree">
                        ...
                        <li id="menu-s" class="treeview">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li class=""><a href="{{route('admin')}}"><i class="fa fa-circle-o"></i> List</a></li>
                            </ul>
                        </li>
                        ...
                        <li id="menu-s" class="treeview">
                            ...
                            <ul class="treeview-menu">
                                <li class="add-users"><a href="{{route('company.create')}}"><i class="fa fa-circle-o"></i> Add / Edit</a></li>
                                <li class=""><a href="{{route('company.index')}}"><i class="fa fa-circle-o"></i> List</a></li>
                            </ul>
                        </li>
                    </ul>
                </section>
